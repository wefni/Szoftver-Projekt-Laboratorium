...
cat Input/Saboteur_Lep_Ures_Es_Ragados_Csore.txt | java -jar *.jar > /dev/null 2>&1 & #txt végére mindig kell egy exit
sleep 1

#Jelenlegi teszt
echo "Teszt - Saboteur_Lep_Ures_Es_Ragados_Csore"

URES=$(grep -ci "pipe-22 ra/re ráléphetnek?  | onComponent.isEmpty(): true" "$FILE")
