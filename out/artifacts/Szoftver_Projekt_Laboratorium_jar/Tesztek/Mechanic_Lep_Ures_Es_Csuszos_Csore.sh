...
cat ../Input/Mechanic_Lep_Ures_Es_Csuszos_Csore.txt | java -jar ../*.jar > /dev/null 2>&1 & #txt végére mindig kell egy exit

#Jelenlegi teszt
echo "Teszt - Mechanic_Lep_Ures_Es_Csuszos_Csore"
